...
class StatusCliTests(unittest.TestCase):
    def test_default_refresh_intervals_are_60_seconds(self) -> None:
        ...
        self.assertEqual(args.dynamic_refresh_seconds, 5.0)
        self.assertEqual(args.dynamic_batch_size, 10)
        self.assertEqual(args.odds_refresh_seconds, 5.0)
        self.assertEqual(args.odds_batch_size, 6)
        self.assertEqual(args.odds_match_concurrency, 3)
        self.assertEqual(args.odds_match_timeout_seconds, 60.0)
        self.assertEqual(args.odds_page_concurrency, 12)
